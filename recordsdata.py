# Adapted from: https://github.com/Scarygami/location-history-json-converter/blob/master/location_history_json_converter.py
# 
# #!/usr/bin/env python3
...
def convert( locations, output,  polygon):
...
#             chronological=False):
    ...
    _write_header(output, format, None, separator)
    print("Progress:")
...
def main():
    ...
    lat1, lon1 = (53.540778449002666, -113.6013767702991)  #Top left of ETC
    lat2, lon2 = (53.5402904290493, -113.60087606578637)   # bottom right of ETC
    ext = [
    ...
    items = ijson.items(open("Records.json", "r"), "locations.item")
